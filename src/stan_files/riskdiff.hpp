...
namespace model_riskdiff_namespace {
...
class model_riskdiff
  : public stan::model::model_base_crtp<model_riskdiff> {
private:
        int ns;
        ...
        double tau_max;
public:
    model_riskdiff(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_riskdiff_namespace::model_riskdiff";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        eta = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(-(1), 1, eta);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                eta = in__.scalar_lub_constrain(-(1), 1, lp__);
            else
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_riskdiff_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_riskdiff_namespace::model_riskdiff stan_model;
